				...
				<div class="box_c">
					...
					<div class="box_c_content">
						<div class="tab_pane" style="">
							<form action="../includes/uploadfile.php" method="post" class="nice custom" enctype="multipart/form-data">
								<input type="hidden" name="folder" value="usuarios" />
								<input type="hidden" name="name_image" value="<?php echo $Imagen; ?>" />
								<input type="hidden" name="redirect_to" value="../users/changeimage.php" />
								<div class="formRow">
									<img src="<?php echo $USER_IMAGE_PATH; ?>?<?php echo filemtime("../data/" . $USER_IMAGE_PATH)?>" style="height: 100px;" alt="" /> 
								</div>
								<div class="formRow">
								...
								<div class="formRow">
									<label class="sepH_b">Imagen</label>
									<input type="file" id="file" name="file" class="input-text large" value="">
								</div>
								<div class="formRow">
