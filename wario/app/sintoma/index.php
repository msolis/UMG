	        ...
	        <div class="box_c">
	            ...
	            <div class="box_c_content">
	                ...
	                <table cellpadding="0" cellspacing="0" border="0" class="display mobile_dt1 dt_act dataTable" id="dt1" aria-describedby="dt1_info">
                        <thead>
                            <tr role="row">
                            	<th class="essential sorting_asc">#</th>
                            	<th class="essential sorting">Descripcion</th>
	                	...
	                	<?php 
		                	...
		                	$stmt = $db->prepare('select id, descripcion, estatus from sintoma where corporacion = ?;');
