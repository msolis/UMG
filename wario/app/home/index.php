				...
				<div class="six columns">
					<div class="user_box cf">
						...
						<div class="user_info user_sep">
							...
							<span>
								<a href="#" class="sep">Configuraciones</a>
					...
					<nav id="smoothmenu_h" class="ddsmoothmenu">
                        <ul class="cf l_tinynav1">
						    <li style="z-index: 100;">
								<a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">Dashboard<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
								<ul style="top: 32px; visibility: visible; left: 0px; width: 146px; display: none;">
						            <li><a href="index.php?uid=1&amp;page=dashboard">Regular</a></li>
						            <li><a href="index.php?uid=1&amp;page=dashboard_drag">Drag&amp;Drop</a></li>
						        </ul>
							</li>
						    <li style="z-index: 99;">
						        <a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">Forms<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="top: 32px; visibility: visible; left: 0px; width: 146px; display: none;">
						            <li><a href="index.php?uid=1&amp;page=form_elements">Form elements</a></li>
						            <li><a href="index.php?uid=1&amp;page=form_extended">Form elements (extended)</a></li>
						            <li><a href="index.php?uid=1&amp;page=form_validation">Form validation</a></li>
						            <li><a href="index.php?uid=1&amp;page=form_example">Form example</a></li>
						        </ul>
						    </li>
						    <li style="z-index: 98;">
						        <a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">UI Elements<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="top: 32px; visibility: visible; left: 0px; width: 162px; display: none;">
						    ...
						    <li style="z-index: 97;">
						        <a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">Plugins<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="top: 32px; visibility: visible; left: 0px; width: 146px; display: none;">
						    ...
						    <li style="z-index: 96;">
						        <a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">Navigation<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="top: 32px; visibility: visible; left: 0px; width: 146px; display: none;">
						    ...
						    <li style="z-index: 95;">
						        <a href="javascript:void(0)" class="mb_parent" style="padding-right: 23px;">Error Pages<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="top: 32px; visibility: visible; left: 0px; width: 146px; display: none;">
						    ...
						    <li style="z-index: 94;">
						        <a href="javascript:void(0)" class="mb_parent pageselected" style="padding-right: 23px;">Sub-levels<img src="img/blank.gif" class="downarrowclass" style="border:0;"></a>
						        <ul style="display: none; top: 32px; visibility: visible;">
						            <li style="z-index: 93;">
						                <a href="#">First level<img src="img/blank.gif" class="rightarrowclass" style="border:0;"></a>
						                <ul style="display: none; top: 0px; visibility: visible;">
						                    <li style="z-index: 92;">
						                        <a href="#">Second level<img src="img/blank.gif" class="rightarrowclass" style="border:0;"></a>
						                        <ul style="display: none; top: 0px; visibility: visible;">
						...
						<select class="tinynav tinynav1">
							...
							<option value="javascript:void(0)">Dashboard</option>
							...
							<option value="javascript:void(0)">Plugins</option>
							...
							<option value="javascript:void(0)">Error Pages</option>
							...
							<option value="javascript:void(0)">Sub-levels</option>
