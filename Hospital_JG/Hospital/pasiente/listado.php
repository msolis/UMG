...
<?php
 ...
 $sql="SELECT * FROM hospitaldb.pasientes";
          ...
          {
        echo "<TR><TD>".$row["ID_PASIENTE"]."</TD><TD>".$row["NOMBRE"]."</TD><TD>".$row["DIRECCION"]."</TD><TD>".$row["TELEFONO"]."</TD><TD>".$row["TIPO_SANGRE"]."</TD><TD>".$row["PESO"]."</TD><TD>".$row["ESTATUS"]."</TD></TR>";
          }
          echo "</table>";
          mysql_close();
?>
